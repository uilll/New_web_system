...
class ChipsController extends BaseController {
    ...
    function upload(Request $request){
      ...
      $chips_algar [] = array();
      $devices = UserRepo::getDevices($this->user->id);
      $chips_encontrados [] = array();
      $chips_para_cancelar [] = array();
      $chips_veiculos_desativados [] = array();
      $chips_sem_realacao [] = array();
      $chips_ativos=0;
      ...
      $cabecalho = array('simcard(msisdn)','imei','iccid(icc)','serial','nome');
