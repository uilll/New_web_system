...
class I18N_Arabic
{
     ...
     * @param  bool  $useAutoload    True to use Autoload (default is false)
     * @param  bool  $useException   True to use Exception (default is false)
     * @param  bool  $compatibleMode True to support old naming style before
    ...
    public function __call($methodName, $arguments)
    {
        ...
        $value = call_user_func_array([&$this->myObject, $methodName], $params);
     ...
     * @return bool True if the input HTML is belong to a forum page
     *
     * @author Khaled Al-Shamaa <khaled@ar-php.org>
     */
