...
{
    private static $_arFinePatterns = ["/'+/u", "/([\- ])'/u", '/(.)#/u'];

    private static $_arFineReplacements = ["'", '\\1', "\\1'\\1"];

    private static $_en2arPregSearch = [];

    private static $_en2arPregReplace = [];

    private static $_en2arStrSearch = [];

    private static $_en2arStrReplace = [];

    private static $_ar2enPregSearch = [];

    private static $_ar2enPregReplace = [];

    private static $_ar2enStrSearch = [];

    private static $_ar2enStrReplace = [];

    private static $_diariticalSearch = [];

    private static $_diariticalReplace = [];

    private static $_iso233Search = [];

    private static $_iso233Replace = [];

    private static $_rjgcSearch = [];

    private static $_rjgcReplace = [];

    private static $_sesSearch = [];

    private static $_sesReplace = [];
