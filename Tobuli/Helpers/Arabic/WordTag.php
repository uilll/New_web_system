...
{
    private static $_particlePreNouns = ['عن', 'في', 'مذ', 'منذ',
        'من', 'الى', 'على', 'حتى',
        'الا', 'غير', 'سوى', 'خلا',
        'عدا', 'حاشا', 'ليس'];

    private static $_normalizeAlef = ['أ', 'إ', 'آ'];

    private static $_normalizeDiacritics = ['َ', 'ً', 'ُ', 'ٌ',
        'ِ', 'ٍ', 'ْ', 'ّ'];
     ...
     * @return bool TRUE if given word is Arabic noun
     *
     * @author Khaled Al-Sham'aa <khaled@ar-php.org>
     */
