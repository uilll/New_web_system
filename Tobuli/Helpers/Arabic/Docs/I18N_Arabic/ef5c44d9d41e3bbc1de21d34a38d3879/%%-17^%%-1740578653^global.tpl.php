...
smarty_core_load_plugins(['plugins' => [['modifier', 'replace', 'global.tpl', 17, false]]], $this); ?>
<?php if (count($this->_tpl_vars['globals']) > 0) { ?>
<?php if (isset($this->_sections['glob'])) {
    unset($this->_sections['glob']);
}
    $this->_sections['glob']['name'] = 'glob';
    $this->_sections['glob']['loop'] = is_array($_loop = $this->_tpl_vars['globals']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
"></a>
 ...
 <span class="smalllinenumber">[line <?php if ($this->_tpl_vars['globals'][$this->_sections['glob']['index']]['slink']) {
     echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['slink'];
 } else {
     echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['line_number'];
 } ?>]</span></h4>
	<div class="tags">
  <?php if ($this->_tpl_vars['globals'][$this->_sections['glob']['index']]['sdesc'] != '') { ?>
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
      $this->_smarty_include(['smarty_include_tpl_file' => 'docblock.tpl', 'smarty_include_vars' => ['sdesc' => $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['sdesc'], 'desc' => $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['desc'], 'tags' => $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['tags']]]);
...
$this->_sections['me']['name'] = 'me';
	    $this->_sections['me']['loop'] = is_array($_loop = $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['global_conflicts']['conflicts']) ? count($_loop) : max(0, (int) $_loop);
	    unset($_loop);
