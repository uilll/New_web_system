...
<?php if (isset($this->_sections['def'])) {
    unset($this->_sections['def']);
}
    $this->_sections['def']['name'] = 'def';
    $this->_sections['def']['loop'] = is_array($_loop = $this->_tpl_vars['defines']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
"></a>
 ...
 <span class="smalllinenumber">[line <?php if ($this->_tpl_vars['defines'][$this->_sections['def']['index']]['slink']) {
     echo $this->_tpl_vars['defines'][$this->_sections['def']['index']]['slink'];
 } else {
     echo $this->_tpl_vars['defines'][$this->_sections['def']['index']]['line_number'];
 } ?>]</span></h3>
	<div class="tags">
 ...
 = <?php echo $this->_tpl_vars['defines'][$this->_sections['def']['index']]['define_value']; ?>
    ...
    $this->_smarty_include(['smarty_include_tpl_file' => 'docblock.tpl', 'smarty_include_vars' => ['sdesc' => $this->_tpl_vars['defines'][$this->_sections['def']['index']]['sdesc'], 'desc' => $this->_tpl_vars['defines'][$this->_sections['def']['index']]['desc'], 'tags' => $this->_tpl_vars['defines'][$this->_sections['def']['index']]['tags']]]);
...
$this->_sections['me']['name'] = 'me';
	    $this->_sections['me']['loop'] = is_array($_loop = $this->_tpl_vars['defines'][$this->_sections['def']['index']]['define_conflicts']['conflicts']) ? count($_loop) : max(0, (int) $_loop);
	    unset($_loop);
