...
smarty_core_load_plugins(['plugins' => [['modifier', 'default', 'class.tpl', 16, false], ['function', 'assign', 'class.tpl', 34, false]]], $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(['smarty_include_tpl_file' => 'header.tpl', 'smarty_include_vars' => ['eltype' => 'class', 'hasel' => true, 'contents' => $this->_tpl_vars['classcontents']]]);
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?>

<?php if ($this->_tpl_vars['conflicts']['conflict_type']) { ?><div class="warning">Conflicts with classes:<br />
	<?php if (isset($this->_sections['me'])) {
	    unset($this->_sections['me']);
	}
$this->_sections['me']['name'] = 'me';
    $this->_sections['me']['loop'] = is_array($_loop = $this->_tpl_vars['conflicts']['conflicts']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
<h3><a href="#class_details"><?php if ($this->_tpl_vars['is_interface']) { ?>Interface<?php } else { ?>Class<?php } ?> Overview</a></h3>
<pre><?php if (isset($this->_sections['tree'])) {
    unset($this->_sections['tree']);
}
        $this->_sections['tree']['name'] = 'tree';
$this->_sections['tree']['loop'] = is_array($_loop = $this->_tpl_vars['class_tree']['classes']) ? count($_loop) : max(0, (int) $_loop);
unset($_loop);
...
if ($this->_sections['tree']['show']) {
    for ($this->_sections['tree']['index'] = $this->_sections['tree']['start'], $this->_sections['tree']['iteration'] = 1;
        ...
        echo $this->_tpl_vars['class_tree']['classes'][$this->_sections['tree']['index']];
        echo $this->_tpl_vars['class_tree']['distance'][$this->_sections['tree']['index']];
    }
} ?></pre><br />
...
<h4 class="classtutorial"><?php if ($this->_tpl_vars['is_interface']) { ?>Interface<?php } else { ?>Class<?php } ?> Tutorial:</h4>
<ul>
...
<h4>Author(s):</h4>
<ul>
  <?php if (isset($this->_sections['tag'])) {
...
<?php echo smarty_function_assign(['var' => 'version', 'value' => ''], $this); ?>

<?php echo smarty_function_assign(['var' => 'copyright', 'value' => ''], $this); ?>
...
if ($this->_sections['tag']['show']) {
  ...
  <?php echo smarty_function_assign(['var' => 'version', 'value' => $this->_tpl_vars['tags'][$this->_sections['tag']['index']]['data']], $this); ?>

  <?php } ?>
  <?php if ($this->_tpl_vars['tags'][$this->_sections['tag']['index']]['keyword'] == 'copyright') { ?>
  <?php echo smarty_function_assign(['var' => 'copyright', 'value' => $this->_tpl_vars['tags'][$this->_sections['tag']['index']]['data']], $this); ?>
...
<ul>
  <?php if (isset($this->_sections['contents'])) {
      unset($this->_sections['contents']);
  }
$this->_sections['contents']['name'] = 'contents';
    $this->_sections['contents']['loop'] = is_array($_loop = $this->_tpl_vars['contents']['var']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
<ul>
  <?php if (isset($this->_sections['contents'])) {
      unset($this->_sections['contents']);
        ...
        $this->_sections['contents']['name'] = 'contents';
    $this->_sections['contents']['loop'] = is_array($_loop = $this->_tpl_vars['contents']['const']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
    $this->_sections['contents']['show'] = true;
    $this->_sections['contents']['max'] = $this->_sections['contents']['loop'];
    $this->_sections['contents']['step'] = 1;
...
<ul>
  <?php if (isset($this->_sections['contents'])) {
      unset($this->_sections['contents']);
        ...
        $this->_sections['contents']['name'] = 'contents';
    $this->_sections['contents']['loop'] = is_array($_loop = $this->_tpl_vars['contents']['method']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
    $this->_sections['contents']['show'] = true;
    $this->_sections['contents']['max'] = $this->_sections['contents']['loop'];
    $this->_sections['contents']['step'] = 1;
...
<h3>Child classes:</h3>
<div class="tags">
<?php if (isset($this->_sections['kids'])) {
    unset($this->_sections['kids']);
}
        $this->_sections['kids']['name'] = 'kids';
    $this->_sections['kids']['loop'] = is_array($_loop = $this->_tpl_vars['children']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
<?php if (isset($this->_sections['iconsts'])) {
    unset($this->_sections['iconsts']);
}
        $this->_sections['iconsts']['name'] = 'iconsts';
    $this->_sections['iconsts']['loop'] = is_array($_loop = $this->_tpl_vars['iconsts']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
<dl>
<?php if (isset($this->_sections['iconsts2'])) {
    unset($this->_sections['iconsts2']);
}
            $this->_sections['iconsts2']['name'] = 'iconsts2';
            $this->_sections['iconsts2']['loop'] = is_array($_loop = $this->_tpl_vars['iconsts'][$this->_sections['iconsts']['index']]['iconsts']) ? count($_loop) : max(0, (int) $_loop);
            unset($_loop);
...
<?php if (isset($this->_sections['ivars'])) {
    unset($this->_sections['ivars']);
}
        $this->_sections['ivars']['name'] = 'ivars';
    $this->_sections['ivars']['loop'] = is_array($_loop = $this->_tpl_vars['ivars']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
<dl>
<?php if (isset($this->_sections['ivars2'])) {
    unset($this->_sections['ivars2']);
}
            $this->_sections['ivars2']['name'] = 'ivars2';
            $this->_sections['ivars2']['loop'] = is_array($_loop = $this->_tpl_vars['ivars'][$this->_sections['ivars']['index']]['ivars']) ? count($_loop) : max(0, (int) $_loop);
            unset($_loop);
...
<div class="tags">
<?php if (isset($this->_sections['imethods'])) {
    unset($this->_sections['imethods']);
}
        $this->_sections['imethods']['name'] = 'imethods';
    $this->_sections['imethods']['loop'] = is_array($_loop = $this->_tpl_vars['imethods']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
<dl>
  <?php if (isset($this->_sections['im2'])) {
      unset($this->_sections['im2']);
  }
            $this->_sections['im2']['name'] = 'im2';
            $this->_sections['im2']['loop'] = is_array($_loop = $this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods']) ? count($_loop) : max(0, (int) $_loop);
            unset($_loop);
...
<h3>Class Details</h3>
<div class="tags">
[line <?php if ($this->_tpl_vars['class_slink']) {
    echo $this->_tpl_vars['class_slink'];
} else {
    echo $this->_tpl_vars['line_number'];
} ?>]<br />
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(['smarty_include_tpl_file' => 'docblock.tpl', 'smarty_include_vars' => ['type' => 'class', 'sdesc' => $this->_tpl_vars['sdesc'], 'desc' => $this->_tpl_vars['desc']]]);
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?>
</div><br /><br />
...
<div class="tags">
<?php $_smarty_tpl_vars = $this->_tpl_vars;
    $this->_smarty_include(['smarty_include_tpl_file' => 'var.tpl', 'smarty_include_vars' => []]);
    $this->_tpl_vars = $_smarty_tpl_vars;
    unset($_smarty_tpl_vars);
    ?>
</div><br />
...
<div class="tags">
<?php $_smarty_tpl_vars = $this->_tpl_vars;
    $this->_smarty_include(['smarty_include_tpl_file' => 'method.tpl', 'smarty_include_vars' => []]);
    $this->_tpl_vars = $_smarty_tpl_vars;
    unset($_smarty_tpl_vars);
    ?>
</div><br />
...
<div class="tags">
<?php $_smarty_tpl_vars = $this->_tpl_vars;
    $this->_smarty_include(['smarty_include_tpl_file' => 'const.tpl', 'smarty_include_vars' => []]);
    $this->_tpl_vars = $_smarty_tpl_vars;
    unset($_smarty_tpl_vars);
    ?>
</div><br />
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(['smarty_include_tpl_file' => 'footer.tpl', 'smarty_include_vars' => []]);
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?>