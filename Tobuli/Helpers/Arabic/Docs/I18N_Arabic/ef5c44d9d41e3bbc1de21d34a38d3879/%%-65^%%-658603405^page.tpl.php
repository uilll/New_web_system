...
$this->_smarty_include(['smarty_include_tpl_file' => 'header.tpl', 'smarty_include_vars' => ['eltype' => 'Procedural file', 'class_name' => $this->_tpl_vars['name'], 'hasel' => true, 'contents' => $this->_tpl_vars['pagecontents']]]);
...
<?php } ?>
<h2>Classes:</h2>
<?php if (isset($this->_sections['classes'])) {
    unset($this->_sections['classes']);
}
$this->_sections['classes']['name'] = 'classes';
    $this->_sections['classes']['loop'] = is_array($_loop = $this->_tpl_vars['classes']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
<h2>Page Details:</h2>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(['smarty_include_tpl_file' => 'docblock.tpl', 'smarty_include_vars' => ['type' => 'page']]);
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?>
<br /><br />
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(['smarty_include_tpl_file' => 'include.tpl', 'smarty_include_vars' => []]);
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?>
<br /><br />
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(['smarty_include_tpl_file' => 'global.tpl', 'smarty_include_vars' => []]);
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?>
<br /><br />
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(['smarty_include_tpl_file' => 'define.tpl', 'smarty_include_vars' => []]);
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?>
<br />
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(['smarty_include_tpl_file' => 'function.tpl', 'smarty_include_vars' => []]);
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?>
