...
$this->_smarty_include(['smarty_include_tpl_file' => 'header.tpl', 'smarty_include_vars' => ['noleftindex' => true]]);
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?>
<?php if (isset($this->_sections['files'])) {
    unset($this->_sections['files']);
}
$this->_sections['files']['name'] = 'files';
$this->_sections['files']['loop'] = is_array($_loop = $this->_tpl_vars['files']) ? count($_loop) : max(0, (int) $_loop);
unset($_loop);
...
<h2>Warnings:</h2><br>
<?php if (isset($this->_sections['warnings'])) {
    unset($this->_sections['warnings']);
}
            $this->_sections['warnings']['name'] = 'warnings';
    $this->_sections['warnings']['loop'] = is_array($_loop = $this->_tpl_vars['issues']['warnings']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
<h2>Errors:</h2><br>
<?php if (isset($this->_sections['errors'])) {
    unset($this->_sections['errors']);
}
        $this->_sections['errors']['name'] = 'errors';
            $this->_sections['errors']['loop'] = is_array($_loop = $this->_tpl_vars['issues']['errors']) ? count($_loop) : max(0, (int) $_loop);
            unset($_loop);
