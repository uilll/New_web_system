...
smarty_core_load_plugins(['plugins' => [['function', 'assign', 'header.tpl', 15, false], ['function', 'eval', 'header.tpl', 76, false], ['modifier', 'capitalize', 'header.tpl', 95, false]]], $this); ?>
<html>
<head>
...
media/empty.png" width="1" height="1" border="0" alt=""  /></td></tr>
  <tr>
    <td class="header_menu">
        <?php echo smarty_function_assign(['var' => 'packagehaselements', 'value' => false], $this); ?>
        ...
        <?php if (count($_from = (array) $this->_tpl_vars['packageindex'])) {
            ...
            <?php if (in_array($this->_tpl_vars['package'], $this->_tpl_vars['thispackage'])) { ?>
                <?php echo smarty_function_assign(['var' => 'packagehaselements', 'value' => true], $this); ?>
...
<?php if (count($this->_tpl_vars['ric']) >= 1) { ?>
	<div id="ric">
		<?php if (isset($this->_sections['ric'])) {
		    unset($this->_sections['ric']);
		}
$this->_sections['ric']['name'] = 'ric';
    $this->_sections['ric']['loop'] = is_array($_loop = $this->_tpl_vars['ric']) ? count($_loop) : max(0, (int) $_loop);
    unset($_loop);
...
<?php if ($this->_tpl_vars['hastodos']) { ?>
	<div id="todolist">
			<p><a href="<?php echo $this->_tpl_vars['subdir'];
			echo $this->_tpl_vars['todolink']; ?>
">Todo List</a></p>
	</div>
<?php } ?>
      <b>Packages:</b><br />
      <?php if (isset($this->_sections['packagelist'])) {
          unset($this->_sections['packagelist']);
      }
        $this->_sections['packagelist']['name'] = 'packagelist';
$this->_sections['packagelist']['loop'] = is_array($_loop = $this->_tpl_vars['packageindex']) ? count($_loop) : max(0, (int) $_loop);
unset($_loop);
...
if ($this->_sections['packagelist']['show']) {
    for ($this->_sections['packagelist']['index'] = $this->_sections['packagelist']['start'], $this->_sections['packagelist']['iteration'] = 1;
        ...
        ?>
        <a href="<?php echo $this->_tpl_vars['subdir'];
        echo $this->_tpl_vars['packageindex'][$this->_sections['packagelist']['index']]['link']; ?>
...
<?php if ($this->_tpl_vars['tutorials']) { ?>
		...
		<?php if ($this->_tpl_vars['tutorials']['pkg']) { ?>
			...
			<?php if (isset($this->_sections['ext'])) {
			    unset($this->_sections['ext']);
			}
    $this->_sections['ext']['name'] = 'ext';
		    $this->_sections['ext']['loop'] = is_array($_loop = $this->_tpl_vars['tutorials']['pkg']) ? count($_loop) : max(0, (int) $_loop);
		    unset($_loop);
		...
		<?php if ($this->_tpl_vars['tutorials']['cls']) { ?>
			...
			<?php if (isset($this->_sections['ext'])) {
		        ...
		        $this->_sections['ext']['name'] = 'ext';
		    $this->_sections['ext']['loop'] = is_array($_loop = $this->_tpl_vars['tutorials']['cls']) ? count($_loop) : max(0, (int) $_loop);
		    unset($_loop);
		    $this->_sections['ext']['show'] = true;
		    $this->_sections['ext']['max'] = $this->_sections['ext']['loop'];
		    $this->_sections['ext']['step'] = 1;
		...
		<?php if ($this->_tpl_vars['tutorials']['proc']) { ?>
			...
			<?php if (isset($this->_sections['ext'])) {
		        ...
		        $this->_sections['ext']['name'] = 'ext';
		    $this->_sections['ext']['loop'] = is_array($_loop = $this->_tpl_vars['tutorials']['proc']) ? count($_loop) : max(0, (int) $_loop);
		    unset($_loop);
		    $this->_sections['ext']['show'] = true;
		    $this->_sections['ext']['max'] = $this->_sections['ext']['loop'];
		    $this->_sections['ext']['step'] = 1;
...
<?php } ?>
      <?php if (! $this->_tpl_vars['noleftindex']) {
          echo smarty_function_assign(['var' => 'noleftindex', 'value' => false], $this);
      } ?>
      <?php if (! $this->_tpl_vars['noleftindex']) { ?>
      <?php if ($this->_tpl_vars['compiledfileindex']) { ?>
      <b>Files:</b><br />
      <?php echo smarty_function_eval(['var' => $this->_tpl_vars['compiledfileindex']], $this); ?>

      <?php } ?>

      <?php if ($this->_tpl_vars['compiledinterfaceindex']) { ?>
      <b>Interfaces:</b><br />
      <?php echo smarty_function_eval(['var' => $this->_tpl_vars['compiledinterfaceindex']], $this); ?>

      <?php } ?>

      <?php if ($this->_tpl_vars['compiledclassindex']) { ?>
      <b>Classes:</b><br />
      <?php echo smarty_function_eval(['var' => $this->_tpl_vars['compiledclassindex']], $this); ?>
...
<?php if (! $this->_tpl_vars['hasel']) {
    echo smarty_function_assign(['var' => 'hasel', 'value' => false], $this);
} ?>
<?php if ($this->_tpl_vars['hasel']) { ?>
