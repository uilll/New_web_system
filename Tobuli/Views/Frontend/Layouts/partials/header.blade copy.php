        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-header-navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" role="button" id="dropMessages" data-toggle="dropdown" rel="tooltip" data-placement="bottom" title="{!!trans('front.messages')!!}">
                            <span class="fa fa-inbox"></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropMessages">
                            <li>
                                <a href="javascript:" data-url="{!!route('messages.client_index')!!}" data-modal="messages" role="button" rel="tooltip" data-placement="bottom" title="{!!trans('front.chat')!!}">
                                    <span class="fa fa-inbox"></span>
                                    <span class="text">Central de mensagens</span>
                                </a>
                            </li>
                            <li>
