...
@section('body')
    ...
    <div class="row">
        <div class="col-md-6 sen-data-fields">
            ...
            <div class="sensors_form_inputs acc harsh_acceleration harsh_breaking ignition door seatbelt engine logical">
                <div class="form-group">
                    <div class="checkbox">
            ...
            <div class="sensors_form_inputs battery_value_by formula temperature temperature_calibration odometer_value_by connected_odometer tachometer numerical fuel_tank fuel_tank_calibration ">
                <div class="form-group">
            ...
            <div class="sensors_form_inputs ignition door seatbelt engine notsetflag drive_business drive_private logical route_color">
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-6 sensors_form_inputs satellites engine_hours gsm">
                    <div class="form-group">
                        <div class="checkbox">
