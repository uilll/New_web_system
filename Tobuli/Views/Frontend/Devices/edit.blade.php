...
@section('title')
    <i class="icon device"></i> {!!trans('global.edit')!!} veículo
@stop
    ...
    <div class="tab-content">
        <div id="device-form-main" class="tab-pane active">
            ...
            <div class="form-group">
                ...
                {!! Form::select('name', $customers, $customer_id, ['class' => 'form-control', 'data-live-search' => true]) !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!!Form::text('imei', $item->imei, ['class' => 'form-control', 'placeholder' => trans('front.imei_placeholder'), 'readonly'])!!}
                <div class="input-group">
                    <div class="checkbox input-group-btn">
                                {!! Form::hidden('enable_imei2', 0) !!}
            ...
            <div class="form-group">
                <div class="checkbox">
                    {!! Form::hidden('remove_tracker', 0) !!}
                    {!! Form::checkbox('remove_tracker', 1, false) !!}
                    {!! Form::label(null, 'Remover Rastreador') !!}
                </div>
            </div>
            @if (isAdmin())
                <div class="form-group">
        ...
        <div id="device-form-advanced" class="tab-pane">
            ...
            <div class="row">  
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!!Form::text('model_year', $item->model_year, ['class' => 'form-control'])!!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {!!Form::label('vehicle_color', 'Cor do veículo:')!!}
                        {!!Form::text('vehicle_color', $item->vehicle_color, ['class' => 'form-control'])!!}
                    </div>
                </div>
            </div>
            ...
            <div class="row">  
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!!Form::text('chassis', $item->chassis, ['class' => 'form-control'])!!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {!!Form::label('renavam', 'Renavam:')!!}
                        {!!Form::text('renavam', $item->renavam, ['class' => 'form-control'])!!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!!Form::text('registration_number', $tracker['model'], ['class' => 'form-control', 'readonly'])!!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group"> <!-- $tracker['sim_number'] $tracker['model']-->
                        {!!Form::label('sim_number', trans('validation.attributes.sim_number').':')!!}
                        {!!Form::text('sim_number', $tracker['sim_number'], ['class' => 'form-control', 'readonly'])!!}
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!!Form::text('insta_loc', $item->insta_loc, ['class' => 'form-control'])!!}
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!!Form::text('ICCID', $tracker['iccd'], ['class' => 'form-control', 'readonly'])!!}
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!!Form::text('installation_date', $item->installation_date, ['class' => 'form-control'])!!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {!!Form::label('Data_manutencao', 'Data da manutencao:')!!}
                        {!!Form::text('maintence_date', $item->maintence_date, ['class' => 'form-control'])!!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="checkbox">
                        {!! Form::hidden('block', 0) !!}
                        {!! Form::checkbox('block', 1, $item->block) !!}
                        {!! Form::label('block', 'Bloqueio') !!}
                    </div>
                    <div class="checkbox">
                        {!! Form::hidden('reverse_block', 0) !!}
                        {!! Form::checkbox('reverse_block', 1, $item->reverse_block) !!}
                        {!! Form::label('reverse_block', 'Reverso') !!}
                    </div>
                    <div class="checkbox">
                        {!! Form::hidden('double_equip', 0) !!}
                        {!! Form::checkbox('double_equip', 1, $item->double_equip) !!}
                        {!! Form::label('double_equip', '2 ou mais rastreadores') !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {!!Form::label('relay_location', 'Local do relé:')!!}
                        {!!Form::text('relay_location', $item->relay_location, ['class' => 'form-control'])!!}
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="checkbox">
                    {!! Form::hidden('no_powercut', 0) !!}
                    {!! Form::checkbox('no_powercut', 1, $item->no_powercut) !!}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!!Form::textarea('contact', $item->contact, ['class' => 'form-control', 'rows' => '2'])!!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!!Form::label('Cidade', 'Endereço completo:')!!}
                            {!!Form::textarea('city', $item->city, ['class' => 'form-control', 'rows' => '2'])!!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!!Form::text('user_owner', $item->user_owner, ['class' => 'form-control'])!!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!!Form::label('Senha', 'Senha:')!!}
                            {!!Form::text('passwor_owner', $item->passwor_owner, ['class' => 'form-control'])!!}
                        </div>
            ...
            <div class="form-group">
                ...
                {!!Form::textarea('additional_notes', $item->additional_notes, ['class' => 'form-control', 'rows' => '10'])!!}
            ...
            @if (Auth::User()->perm('forward', 'view'))
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('forward[ip]', array_get($item->forward, 'ip'), array_merge(['class' => 'form-control', 'placeholder' => '10.0.0.0:6000'], (Auth::User()->perm('forward', 'edit') ? [] : ['readonly' => true]))) !!}
