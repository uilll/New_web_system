...
@section('body')
    ...
    <div class="form-group">
        ...
        {!! Form::select('devices[]', $devices->pluck('plate_number', 'id')->all(), null, ['class' => 'form-control multiexpand', 'multiple' => 'multiple', 'data-live-search' => true, 'data-actions-box' => true]) !!}
    </div>
    {!! Form::close() !!} 
