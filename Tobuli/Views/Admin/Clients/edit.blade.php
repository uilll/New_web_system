                    ...
                    @if ( ! Auth::User()->isManager() || Auth::User()->id != $item->id)
                        @if (Auth::User()->isAdmin())
                            <div class="form-group">
                                ...
                                {!! Form::select('group_id', ['1' => trans('admin.group_1'), '3' => trans('admin.group_3'), '2' => trans('admin.group_2'), '4' => trans('admin.group_4'), '5' => "Monitoramento", '6' => "Motorista"], $item->group_id, ['class' => 'form-control']) !!}
                            </div>
                        @else
            ...
            <div class="form-group">
                ...
                <div class="checkboxes">
                    ...
                    @foreach ($maps as $id => $title)
                        <div class="checkbox">
                            {!! Form::checkbox('available_maps['.$id.']', $id, in_array($id, $item->available_maps)) !!}
