...
@section('body')
    ...
    <div class="tab-content">
        <div id="client-add-form-main" class="tab-pane active">
            ...
            <!--<div class="form-group">
                {!! Form::label('client_user', trans('front.user').':') !!}
                {!! Form::text(trans('front.user'), null, ['class' => 'form-control']) !!}
            </div> -->
			<div class="form-group">
                ...
                <div class="col-sm-6">
                    @if (Auth::User()->isAdmin())
                        <div class="form-group">
                            ...
                            {!! Form::select('group_id', ['1' => trans('admin.group_1'), '3' => trans('admin.group_3'), '2' => trans('admin.group_2'), '4' => trans('admin.group_4'), '5' => "Monitoramento", '6' => "Motorista"], 2, ['class' => 'form-control']) !!}
                        </div>
                    @else
            ...
            <div class="form-group">
                ...
                <div class="checkboxes">
                    ...
                    @foreach ($maps as $id => $title)
                        <div class="checkbox">
                            {!! Form::checkbox('available_maps['.$id.']', $id, in_array($id, settings('main_settings.available_maps')) ) !!}
            ...
            <div class="form-group">
                <div class="checkbox">
                    {!! Form::checkbox('account_created', 0, 0) !!}
