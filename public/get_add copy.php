...
if(!empty($lat) && !empty($lng)):
	if ($map=='google'){ 
		...
		// https://nominatimosrm.carseg.com.br/nominatim/reverse?format=json&lat=-11.2572333&lon=-40.94225
...
if (!empty($queries)){
 ...
 function get_distance($lat_local,$lon_local,$city,$state){
	...
	// https://nominatimosrm.carseg.com.br/osrm/route/v1/driving/13.388860,52.517037;13.385983,52.496891?steps=true
	$server = 'nominatimosrm.carseg.com.br/osrm'; // or IP address nominatimosrm.carseg.com.br
